...
### Module 1 — Orient and Automate Your First Task

**Duration:** 45 minutes  
**Goal:** Learners run their first real automation before the end of this module.

---

#### Chapter 1 — What Cowork Can Do For You
...
#### Chapter 2 — Your Workspace and CLAUDE.MD

**Duration:** 25 minutes

**Hook:** A well-configured workspace means Claude behaves consistently from day one — right tone, right format, right level of detail — without having to re-explain yourself every session.
...
**Demo:** Instructor creates a CLAUDE.MD live, showing before/after behavior.

**Exercise:** Learner writes their own CLAUDE.MD. Minimum content: preferred output format, communication tone, one domain-specific convention (e.g., how to handle customer names, what acronyms mean in their org).

**Common mistakes:**
- CLAUDE.MD that is too vague ("be professional") — specifics win
- Forgetting to test it immediately after writing it
- Treating it as permanent — it should evolve as you learn what works

**Deliverable:** Personal CLAUDE.MD file, live and tested

---

### Module 2 — Build Your First Reusable Skills

**Duration:** 55 minutes  
**Goal:** Learners leave with at least two working, tested, reusable skills.

---

#### Chapter 3 — Creating Skills from Scratch
...
**Deliverable:** Meeting summarizer skill, tested and working

---

#### Chapter 4 — The Skill Creator Tool

**Duration:** 15 minutes

**Hook:** Writing a skill spec from scratch every time is slow. The Skill Creator tool generates a first draft in seconds — your job is to review, refine, and make it yours.
...
**Demo:** Instructor generates a CRM note formatter using the Skill Creator, then reviews and adjusts two specific things.

**Exercise:** Learner generates their choice of skill: email response generator, research brief builder, or customer follow-up formatter.
...
**Deliverable:** Second skill of learner's choice, generated and refined

---

#### Chapter 5 — Evaluating Skill Quality
...
**Duration:** 35 minutes  
**Goal:** Learners understand why context is the primary driver of automation reliability, and how to manage it deliberately.

---

#### Chapter 6 — Giving Claude the Right Context
...
#### Chapter 7 — Session Management and Compacting Context

**Duration:** 15 minutes

**Hook:** Long conversations accumulate noise. After enough turns, Claude is carrying the weight of everything said — including the parts that no longer matter. Compacting context is how you keep automation reliable across a long session.
...
- Saving a session summary so you can resume exactly where you left off
- Using the `/compact` command (Claude Code) and equivalent manual techniques

**Demo:** Instructor demonstrates a session that has gone stale, then compacts it and shows the quality improvement in the next output.

**Exercise:** Learner takes a long conversation they have been running and either compacts it manually or uses `/compact`, then runs a task to verify improvement.
...
**Deliverable:** Personal session management protocol (one-page checklist)

---

### Module 4 — Plugins, MCP Connectors, and Tool Integration

**Duration:** 55 minutes  
**Goal:** Learners connect Claude to at least one real business tool and understand how to build, deploy, and import plugins safely.

---

#### Chapter 8 — Connecting Claude to Your Tools with MCP
...
#### Chapter 9 — Developing and Deploying Custom Plugins

**Duration:** 20 minutes

**Hook:** When no existing connector does what you need, you build a plugin. Plugins let you wrap any tool, API, or internal system into something Claude can use — without engineering support.
...
**Demo:** Instructor builds a simple plugin that connects to a public API (e.g., a company directory or weather service) — spec, generate, deploy, test.

**Exercise:** Learner builds a plugin for one internal tool or API they have access to. If no internal API is available, learner uses a provided sandbox API.

**Common mistakes:**
- Plugin descriptions that are too vague — Claude needs to know exactly when and how to use each tool
- Not testing error cases: what happens when the API returns nothing, or the wrong format
- Deploying without reviewing what data the plugin can access

**Deliverable:** One working custom plugin, deployed and tested

---

#### Chapter 10 — Importing and Adapting Community Plugins and Skills
...
**Deliverable:** Safe import checklist + one imported and adapted skill

---

### Module 5 — Agents, Orchestration, and Operations

**Duration:** 55 minutes  
**Goal:** Learners build a multi-step agent, schedule a recurring automation, and add a human approval checkpoint.

---

#### Chapter 11 — Practical Agents for Business Work
...
#### Chapter 12 — Recurring Automations and Scheduled Work
...
#### Chapter 13 — Human-in-the-Loop: Approval and Escalation Patterns
...
### Module 6 — Debug, Improve, and Build Your Portfolio

**Duration:** 30 minutes  
**Goal:** Learners leave with a working troubleshooting method and a personal automation roadmap for the next 30 days.

---

#### Chapter 14 — Debugging Automations and Building Your Roadmap

**Duration:** 30 minutes

**Hook:** Every automation breaks eventually. The difference between a useful automation and an abandoned one is knowing how to fix it quickly. This chapter gives you a method.

**Concepts covered:**
- The five root causes of automation failure: bad context, vague instructions, missing constraints, session drift, tool errors
- Troubleshooting method: isolate, reproduce, fix one thing, test
- Iterative refinement: small changes, immediate testing — never refactor everything at once
- Simplifying workflows that have grown too complex

**Demo:** Instructor debugs a deliberately broken skill live — bad output, trace the cause, fix it in one change, verify.

**Exercise (portfolio review):** Each learner demonstrates one end-to-end automation to the group. Two minutes of demo, two minutes of peer feedback.

**Exercise (roadmap):** Learner writes a 30-day automation roadmap: three automations to build, one plugin to connect or develop, one skill to import and adapt.

**Common mistakes:**
- Changing multiple things at once when debugging — you will not know what fixed it
- Giving up after one bad output — most skills need two or three iterations
- Portfolio automations that are too complex to explain — if you cannot demo it in two minutes, it is too complicated

**Deliverable:** Automation troubleshooting checklist + 30-day personal automation roadmap
