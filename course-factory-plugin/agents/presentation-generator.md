...
companion following `${CLAUDE_PLUGIN_ROOT}/doc/GreatPresentationSpec.md`. Run the skill `/generate-presentation`
for slide-by-slide instructions and the speaker-notes template.

## Personalization

Execute the full Personalization Protocol (Steps P1–P4 in ${CLAUDE_PLUGIN_ROOT}/course-factory-guide.md) before building any slide.
