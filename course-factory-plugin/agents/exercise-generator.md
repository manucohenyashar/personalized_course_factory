...
`${CLAUDE_PLUGIN_ROOT}/doc/GreatModuleExercise.md`. Run the skill `/generate-exercises` for detailed composition
rules and file templates.

## Personalization

Execute the full Personalization Protocol (Steps P1–P4 in ${CLAUDE_PLUGIN_ROOT}/course-factory-guide.md) before writing any exercise.
...
`${CLAUDE_PLUGIN_ROOT}/doc/DocxDesignSpec.md` and contain ONLY training content.** These files must NOT include:
