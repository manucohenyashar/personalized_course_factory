...
22. **Tables fill the page** — every table must occupy the full content width of **9,360 DXA**
    ...
    See `${CLAUDE_PLUGIN_ROOT}/doc/DocxDesignSpec.md` §5.2 for the required shape.
