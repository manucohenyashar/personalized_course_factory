...
- `tutorial.handoff.json` (section Bloom tags, LO refs)
...
## Handoff JSON Schema (`tutorial.handoff.json`)
...
outputs/
  {course_slug}/
    ...
    chapters/
      ch{NN}-{chapter_slug}/
        tutorial.docx                          ← chapter doc (Word)
        tutorial.handoff.json                  ← internal handoff
...
- **Chapter artifact files are named by artifact role only** — `tutorial.docx`, `tutorial.handoff.json`,
